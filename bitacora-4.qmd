...
---
# Bitácora 4: Revisión y depuración final
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_uno
#| fig-cap: "Comparación del nivel educativo de los padres y el tipo de estudiante. Elaboración propia. @data"
#| 
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_dos
#| fig-cap: "Relación entre persona deudora y resultado académico. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_tres
#| fig-cap: "Frecuencia de Estudiantes Graduados, Matriculados o Desertores según su categoría de beca. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_cuatro
#| fig-cap: "Comparación en la frecuencia del estado de los estudiantes según su nacionalidad. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_cinco
#| fig-cap: "Densidades de créditos aprobados en primer semestre por tipo de estudiante. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_seis
#| fig-cap: "Distribución de estudiantes según su género. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_siete
#| fig-cap: "Dispersión de promedios del primer año lectivo según la categoría del estudiante. Elaboración propia. @data"
grafico_siete<-df %>% 
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_ocho
#| fig-cap: "Distribución de estudiantes según categoría y desplazamiento. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_nueve
#| fig-cap: "Distribución de las notas de admisión por categoría. Elaboración propia. @data"
...
```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_diez
#| fig-cap: "Densidades de edad de admisión por categoría de estudiante. Elaboración propia. @data"
...
Este gráfico de barras relaciona las variables categóricas del horario en el cuál se reciben las clases y si el estudiante completo su educación, está en proceso de o no lo hizo. El horario de clases se muestra por el color, uno siendo para clases diurnas y el otro para nocturnas.


```{r, echo = TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_once
#| fig-cap: "Estado del estudiante y horario de clases. Elaboración propia. @data"
...
```{r, echo=TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_doce
#| fig-cap: "Distribución de Estado Civil por Rendimiento Académico. Elaboración propia. @data"
...
```{r, echo=TRUE, message=FALSE, warning=FALSE}
#| label: fig-grafica_trece
#| fig-cap: "Cantidad de estudiantes por orden de aplicación y categoría. Elaboración propia. @data"
...
```
```{r}
#| label: tbl-tablacuatro
#| tbl-cap: "Estadísticas de las notas del primer semestre según el tipo de estudiante. Elaboración propia. @data"

kable(head(tabla_cuatro))
```
...
```{r}
#| label: tbl-tablacinco
#| tbl-cap: "Análisis estadístico de las notas en el primer y segundo semestre. Elaboración propia. @data"

kable(head(tabla_cinco))
```
...
```{r}
#| label: tbl-tablaseis
#| tbl-cap: "Distribución de Estudiantes según el curso. Elaboración propia. @data"
kable(head(tabla_seis))
